...
MEDIA_ROOT = os.path.join(PROJECT_ROOT, 'grandma', 'public', 'media')
...
STATIC_ROOT = os.path.join(PROJECT_ROOT, 'grandma', 'public', 'static')
...
STATICFILES_DIRS = (
    os.path.join(PROJECT_ROOT, 'grandma', 'static'),
)
