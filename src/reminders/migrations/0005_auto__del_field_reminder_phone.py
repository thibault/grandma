...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Reminder.phone'
        raise RuntimeError("Cannot reverse this migration. 'Reminder.phone' and its values cannot be restored.")
    ...
    models = {
        ...
        u'reminders.reminder': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reminders'", 'to': u"orm['accounts.User']"}),
